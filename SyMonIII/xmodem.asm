...
ptr		=	$aa		; data pointer (two byte variable)
ptrh		=	$ab		;   "    "

eofp		=	$ac		; end of file address pointer (2 bytes)
eofph		=	$3d		;  "	"	"	"
...
RDoneNow	lda	#ACK		; last block, send ACK and exit.
		jsr	COUT		;
...
StartCrcLp	jsr	CHIN		; get chr from serial port, don't wait 
...
ErrMsg		.text 	"Transfer Error!"
		.BYTE  	CR, LF
                .byte   0
;
Print_Good	; PRINT Good Transfer message
		lda   	#<GoodMsg
		sta 	INDEX
		lda 	#>GoodMsg
		sta 	INDEXH

...
.alias k_ramend $7EFF   ; End of continuous RAM that starts at $0000
                        ; redefined by Forth 
...
; 6850 ACIA UART
; is it reigister compatible with 6551?
.alias ACIAbase $7f70           ; ACIA base address
...
; 65c22 VIA I/O Chip
.alias VIAbase  $7f50           ; VIA base address
